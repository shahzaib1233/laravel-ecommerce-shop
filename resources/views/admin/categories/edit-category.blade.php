    ...
    <section class="content">
        ...
        <div class="container-fluid">
            ...
            <form action="" method="POST" id="categoryform" name="categoryform">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" onchange="getslug()" value="{{  $category->name }}" name="name" id="name" class="form-control"
                                           placeholder="Name">
                                    <h3></h3>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div>
                                <img src="{{  asset('uploads/category/'.$category->image)}}" height="300px" width="300px" alt="">
                            </div>
                            @endif
                        </div>
                        <div class="col-md-6">
                ...
                <div class="pb-5 pt-3">
                    <button class="btn btn-primary" id="create" type="submit">Update</button>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#create').click(function(event){
                ...
                $.ajax({
                    url: '{{ url("admin/categories/update") }}/' + categoryId, // Include the category ID in the URL
                    type: 'put',
