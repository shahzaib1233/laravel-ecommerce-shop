        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="<?php echo e(url('admin/categories/index')); ?>" class="btn btn-primary">Back</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <form action="" method="POST" id="categoryform" name="categoryform">
                ...
                <div class="pb-5 pt-3">
                    ...
                    <a href="<?php echo e(url('admin/categories/index')); ?>" class="btn btn-outline-dark ml-3">Cancel</a>
                </div>
            </form>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#create').click(function(event){
                ...
                $.ajax({
                    url: '<?php echo e(url('admin/categories/store')); ?>',
                    type: 'POST',
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SHAHZAIB IMTIAZ\Desktop\laravel-ecommerce-shop\resources\views/admin/categories/create.blade.php ENDPATH**/ ?>